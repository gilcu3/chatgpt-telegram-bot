...
class UsageTracker:
    ...
    def initialize_all_time_cost(self, tokens_price=0.002, image_prices="0.016,0.018,0.02", minute_price=0.006, tts_prices='0.015,0.030', vision_token_price=0.01):
        ...
        all_time_cost = token_cost + transcription_cost + image_cost + tts_cost + vision_cost
